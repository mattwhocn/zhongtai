...
const trainingData = {
  ...
  introduction: {
    title: '大兴兴宾职业技能培训学校',
    description: `大兴兴宾职业技能培训学校是经北京市大兴区人力资源和社会保障部门审批，北京市民政部门注册的民非企业；由北京市消防协会专家评审通过的开展消防安全教育培训的专业化培训机构。
          ...
          <Row gutter={[48, 48]} align="middle">
            ...
            <Col xs={24} lg={12}>
              <div className="section-text">
                <Paragraph>{trainingData.introduction.description}</Paragraph>
              </div>
            </Col>
          </Row>
        </div>
      ...
      <section className="business-scope">
        <div className="section-content">
          ...
          <Row gutter={[48, 48]} align="middle">
            <Col xs={24} lg={12}>
              <div className="section-text">
                <Paragraph>{trainingData.businessScope.description}</Paragraph>
              </div>
            </Col>
            <Col xs={24} lg={12}>
              <div className="section-image">
